...
module Net::NTLM
  class << self
    # source://rubyntlm//lib/net/ntlm.rb#128
    ...
    #
    # source://rubyntlm//lib/net/ntlm.rb#120
    ...
    #
    # source://rubyntlm//lib/net/ntlm.rb#89
    ...
    #
    # source://rubyntlm//lib/net/ntlm.rb#141
    def lm_hash(password); end

    # source://rubyntlm//lib/net/ntlm.rb#187
    ...
    #
    # source://rubyntlm//lib/net/ntlm.rb#149
    def ntlm_hash(password, opt = T.unsafe(nil)); end

    # source://rubyntlm//lib/net/ntlm.rb#199
    ...
    #
    # source://rubyntlm//lib/net/ntlm.rb#162
    def ntlmv2_hash(user, password, target, opt = T.unsafe(nil)); end

    # source://rubyntlm//lib/net/ntlm.rb#207
    ...
    #
    # source://rubyntlm//lib/net/ntlm.rb#101
    ...
    #
    # source://rubyntlm//lib/net/ntlm.rb#108
    def split7(str); end
  end
end
...
class Net::NTLM::Client::Session
  ...
  # source://rubyntlm//lib/net/ntlm/client/session.rb#46
  def exported_session_key; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#83
  def is_anonymous?; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#75
  def seal_message(message); end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#57
  def sign_message(message); end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#79
  def unseal_message(emessage); end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#66
  def verify_signature(signature, message); end

  private

  # source://rubyntlm//lib/net/ntlm/client/session.rb#202
  def blob; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#181
  def calculate_user_session_key!; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#130
  def client_challenge; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#122
  def client_cipher; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#114
  def client_seal_key; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#106
  def client_sign_key; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#165
  def domain; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#190
  def lmv2_resp; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#149
  def negotiate_key_exchange?; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#198
  def nt_proof_str; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#177
  def ntlmv2_hash; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#194
  def ntlmv2_resp; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#169
  def oem_or_unicode_str(str); end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#157
  def password; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#98
  def raw_sequence; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#94
  def sequence; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#134
  def server_challenge; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#126
  def server_cipher; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#118
  def server_seal_key; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#110
  def server_sign_key; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#213
  def target_info; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#140
  def timestamp; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#144
  def use_oem_strings?; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#90
  def user_session_key; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#153
  def username; end

  # source://rubyntlm//lib/net/ntlm/client/session.rb#161
  def workstation; end
end
...
# source://rubyntlm//lib/net/ntlm/md4.rb#6
class Net::NTLM::Md4
  class << self
    # source://rubyntlm//lib/net/ntlm/md4.rb#15
...
# @private false
#
# source://rubyntlm//lib/net/ntlm/message.rb#47
class Net::NTLM::Message < ::Net::NTLM::FieldSet
  # source://rubyntlm//lib/net/ntlm/message.rb#131
  def data_edge; end

  # source://rubyntlm//lib/net/ntlm/message.rb#110
  def data_size; end

  # source://rubyntlm//lib/net/ntlm/message.rb#104
  def decode64(str); end

  # source://rubyntlm//lib/net/ntlm/message.rb#123
  def deflag; end

  # source://rubyntlm//lib/net/ntlm/message.rb#91
  def dump_flags; end

  # source://rubyntlm//lib/net/ntlm/message.rb#100
  def encode64; end

  # @return [Boolean]
  #
  # source://rubyntlm//lib/net/ntlm/message.rb#83
  ...
  # @return [self]
  #
  # source://rubyntlm//lib/net/ntlm/message.rb#71
  def parse(str); end

  # source://rubyntlm//lib/net/ntlm/message.rb#119
  def security_buffers; end

  # source://rubyntlm//lib/net/ntlm/message.rb#95
  def serialize; end

  # source://rubyntlm//lib/net/ntlm/message.rb#87
  def set_flag(flag); end

  # source://rubyntlm//lib/net/ntlm/message.rb#114
  def size; end

  class << self
    # source://rubyntlm//lib/net/ntlm/message.rb#65
    def decode64(str); end

    # source://rubyntlm//lib/net/ntlm/message.rb#49
    def parse(str); end
  end
end
...
# source://rubyntlm//lib/net/ntlm/rc4.rb#11
class Net::NTLM::Rc4
  # source://rubyntlm//lib/net/ntlm/rc4.rb#12
  def initialize(str); end

  # source://rubyntlm//lib/net/ntlm/rc4.rb#18
  def encrypt(text); end

  private

  # source://rubyntlm//lib/net/ntlm/rc4.rb#33
  def initialize_state(key); end
end

# source://rubyntlm//lib/net/ntlm/rc4.rb#30
Net::NTLM::Rc4::INITIAL_STATE = T.let(T.unsafe(nil), Array)
